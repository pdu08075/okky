...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    localStorage.setItem('userinfo', JSON.stringify({ id: id, password : password, email: email, name : name, nickname : nickname, wishtag : wishtag, emailAgree : emailAgree, type : type, serviceAgree : serviceAgree, personalInfoAgree : personalInfoAgree, provider : "Google", profileImage : profileImage, checkUsernameFlag : checkUsernameFlag}));
        navigate('/oksignup');
